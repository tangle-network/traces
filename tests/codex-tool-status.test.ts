...
describe.each(['function', 'custom'] as const)('Codex %s tool outcomes', (variant) => {
  it.each([
    ...
    { label: 'script receipt with wall-time colon', output: 'Script completed\nWall time: 1.2 seconds\nOutput:\nerror: command failed ENOENT', code: 'OK' },
    { label: 'script receipt without wall-time colon', output: 'Script completed\nWall time 1.2 seconds\nOutput:', code: 'OK' },
    { label: 'failed script receipt without wall-time colon', output: 'Script failed\nWall time 1.2 seconds\nOutput:\nsuccess', code: 'ERROR' },
